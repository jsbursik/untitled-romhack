// Solenne Regional Dex Order
// Generated by tools/gen_dex_order.py — edit by hand after generating.
//
// Each entry is a national dex number in the order it appears in the Solenne Pokedex.
// Regional forms share their base species entry — no separate line needed.
// Legendaries are currently in national-dex position; move them as needed.

#include "global.h"
#include "constants/pokedex.h"

const enum NationalDexOrder sSolenneToNationalOrder[] =
{
    ...
    // ================================================================
    // TODO: These were enabled but not in RevisedList.txt.
    // Place them where they belong above and remove from this section.
    // ================================================================
